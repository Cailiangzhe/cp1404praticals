...
def run_tests():
    ...
    assert car.fuel == 10, "Car does not set fuel correctly when given value"

    default_car = Car()
    assert default_car.fuel == 0, "Car default fuel is not zero"
...
def format_phrase_as_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> format_phrase_as_sentence("this is fun")
    'This is fun.'
    """
    phrase = phrase.strip()
